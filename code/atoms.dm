...
/obj/machinery/atmoalter/siphs/fullairsiphon
	name = "Air siphon"
	icon = 'icons/immibis/atmos.dmi'
	icon_state = "siphon:0"
/obj/machinery/atmoalter/siphs/fullairsiphon/air_vent
	name = "Air regulator"
	icon = 'icons/ss13/aircontrol.dmi'
	icon_state = "vent2"
	t_status = 4.0
	alterable = 0.0
	density = 0	//*****
/obj/machinery/atmoalter/siphs/fullairsiphon/port
	...
	icon = 'icons/immibis/atmos-port.dmi'
	flags = FPRINT
	anchored = 0.0
...
/obj/machinery/computer/sleep_console
	...
	icon = 'icons/goonstation/sleeper.dmi'
...
/obj/machinery/door/window
	name = "interior door"
	icon = 'icons/ss13/windoor.dmi'
	visible = 0.0
	flags = WINDOW
	opacity = 0
/obj/machinery/firealarm
	name = "Fire Alarm"
	icon = 'icons/goonstation/obj/monitors.dmi'
...
/obj/machinery/meter
	...
	icon = 'icons/ss13/pipes.dmi'
	icon_state = "meterX"
	var/obj/machinery/atmospherics/pipes/target = null
	anchored = 1.0
	var/average = 0
...
/obj/machinery/atmospherics/pipes/flexipipe
	desc = "Flexible hose-like piping."
	name = "flexipipe"
	icon = 'icons/ss13/wire.dmi'
	capacity = 10.0
	p_dir = 12.0
/obj/machinery/atmospherics/pipes/high_capacity
	desc = "A large bore pipe with high capacity."
	name = "high capacity"
	icon = 'icons/ss13/hi_pipe.dmi'
	density = 1
	capacity = 1.8E7
/obj/machinery/atmospherics/pipes/insulated
	icon = 'icons/immibis/insulated_pipe.dmi'
	name = "insulated pipe"
	insulation = INSULATEDPIPERATE
...
/obj/machinery/power/smes
	...
	var/n_tag = null
	var/obj/machinery/power/terminal/terminal = null
	var/maxchargelevel = SMESMAXCHARGELEVEL
...
/obj/cable
	...
	icon = 'icons/immibis/power_cable.dmi'
	icon_state = "0-1"
	var/d1 = 0
	var/d2 = 1
	layer = 2.5
