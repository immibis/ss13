...
/obj/machinery/power/smes/proc/updateicon()
	...
	overlays += image('icons/immibis/power.dmi', "smes-op[online]")

	if(charging)
		overlays += image('icons/immibis/power.dmi', "smes-oc1")
	else
		if(chargemode)
			overlays += image('icons/immibis/power.dmi', "smes-oc0")

	var/clevel = chargedisplay()
	if(clevel>0)
		overlays += image('icons/immibis/power.dmi', "smes-og[clevel]")
...
/obj/machinery/power/smes/proc/interact(mob/user)
	...
	t += "Input level:  <A href = '?src=\ref[src];input=-4'>M</A> <A href = '?src=\ref[src];input=-3'>-</A> <A href = '?src=\ref[src];input=-2'>-</A> <A href = '?src=\ref[src];input=-1'>-</A> [add_lspace(chargelevel,10)] <A href = '?src=\ref[src];input=1'>+</A> <A href = '?src=\ref[src];input=2'>+</A> <A href = '?src=\ref[src];input=3'>+</A> <A href = '?src=\ref[src];input=4'>M</A><BR>"

	t += "<BR><BR>"

	t += "Output: [online ? "<B>Online</B> <A href = '?src=\ref[src];online=1'>Offline</A>" : "<A href = '?src=\ref[src];online=1'>Online</A> <B>Offline</B> "]<BR>"

	t += "Output level: <A href = '?src=\ref[src];output=-4'>M</A> <A href = '?src=\ref[src];output=-3'>-</A> <A href = '?src=\ref[src];output=-2'>-</A> <A href = '?src=\ref[src];output=-1'>-</A> [add_lspace(output,10)] <A href = '?src=\ref[src];output=1'>+</A> <A href = '?src=\ref[src];output=2'>+</A> <A href = '?src=\ref[src];output=3'>+</A> <A href = '?src=\ref[src];output=4'>M</A><BR>"
...
/obj/machinery/power/smes/Topic(href, href_list)
	...
	if (( usr.machine==src && (get_dist(src, usr) <= 1 && istype(src.loc, /turf))) || (istype(usr, /mob/ai)))
		...
		if( href_list["close"] )
			...
			chargelevel += d
			chargelevel = max(0, min(maxchargelevel, chargelevel))	// clamp to range
			...
			output += d
			output = max(0, min(maxoutput, output))	// clamp to range
