area/turret_protected
	...
	proc/subjectDied(var/mob/target)
...
/obj/machinery/turret/proc/shootAt(var/mob/target)
	...
	if (src.lasers)
		...
		use_power(TURRET_STUN_POWER)
	else
		A = new /obj/bullet/electrode( loc )
		use_power(TURRET_LETHAL_POWER)
...
/obj/machinery/turretid/proc/updateTurrets()
	...
	if (!istype(loc, /area/turret_protected))
		...
		return
	var/area/turret_protected/area = loc

	if(!enabled)
		area.turretsDisabled()
