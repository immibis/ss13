/mob/ai/Life()
	...
	if (isturf(T))	//let cryo/sleeper handle adjusting body temp in their respective alter_health procs (as if anyone could put the AI in a cryo cell)
		src.bodytemperature = adjustBodyTemp(src.bodytemperature, T.gas.temperature, 1.0)
